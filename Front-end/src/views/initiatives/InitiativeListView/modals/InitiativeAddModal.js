...
const InitiativeAddModal = ({ isInitiativeAddModalOpen, setIsInitiativeAddModalOpen, currentYear }) => {
    ...
    const initiativeAddBody = (
        <div style={modalStyle} className={classes.paper}>
            <form noValidate autoComplete="off">
                <Input placeholder="Initiative Name" onChange={handleNameChange} />
                <br />
